...
if __name__ == "__main__":
    ...
    # result = generate_wann_model(in_scaled, out_scaled, tol=0.0001, gen_num=30, niter=1024,
    #                              sort_type="conn")
    # model = result
    ...
    # result = generate_wann_model(x_scaled, y_scaled, tol=0.0001, gen_num=30, niter=1024,
    #                              sort_type="conn")
    # model = result
